        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Fail to get the list of orders. Error: ".concat(err_1));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        order = result.rows[0];
                        conn.release();
                        console.log("Creating new order who has id: ".concat(o.id));
                        return [2 /*return*/, order];
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Fail to add new order ".concat(o.id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        order = result.rows[0];
                        conn.release();
                        console.log("Adding products to the order who has id : ".concat(order_id));
                        return [2 /*return*/, order];
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("fail toadd product ".concat(product_id, " to order ").concat(order_id, ": ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
